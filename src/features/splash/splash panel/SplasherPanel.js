                ...
                <Paper elevation={10} sx={{ background: theme.palette.background.paper,  }} style={loginPaperStyle}>
                    <Grid container direction="column" justifyContent="center" alignItems='center' spacing={2} >
                        <Grid item xs={12} sx={{width:'100%'}}>
                            <Button component={Link} to='/login' variant='outlined' sx={{width:'100%'}} > Login </Button>
                        </Grid>
                        <Grid item xs={12} sx={{width:'100%'}}>
                            <Button component={Link} to='/registration' variant='outlined' sx={{width:'100%'}} > Go to Registration </Button>
                        </Grid>
                    </Grid>
                </Paper>
            </Grid>
